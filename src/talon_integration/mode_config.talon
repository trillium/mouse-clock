...
grid add <user.line_style>: user.mouse_clock_config_add("grid", "styles", line_style)
grid remove <user.line_style>: user.mouse_clock_config_remove("grid", "styles", line_style)
...
grid reset styles: user.mouse_clock_config_reset("grid", "styles")
