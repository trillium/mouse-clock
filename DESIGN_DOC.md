...
- **Modular Structure**:
  - Core logic in `mouse_clock_talon_integration.py`.
  - Utils in `utils/utils.py` for math (angles, averaging, movement).
  - Talon files separated by context (always, active, settings).
